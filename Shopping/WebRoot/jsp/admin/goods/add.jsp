...
<tr>
	...
	<td><input name="goodstitle"/></td>
</tr>
<tr>
	<td align="right">商品图片:</td>
	<td>
	<input name="goodspic" id="goodspic"/><input type="button" value="上传图片" onclick="upImage()"><div style="color: red;">第一张为封面图，其他为商品图，最多上传3张商品图</div>
	<script type="text/plain" id="j_ueditorupload" style="height:5px;display:none;" ></script>
	</td>
</tr>
<tr>
	<td align="right">商品描述:</td>
	<td> <script id="editor" name="goodsdesc" type="text/plain" style="width:550px;height:200px;"></script>
	</td>
</tr>
<tr>
	<td></td>
