...
<body>
	...
	<div class="top">
    	<div class="top-c">
            ...
            <div class="top-right">
                ...
                <p><a href="order.do?a=userOrder">我的订单</a> | <a href="javascript:;">服务中心</a> | <a href="user.do?a=exit">退出</a></p>
            </div>
        </div>
    </div>
            ...
            <div class="cart-section">
                ...
                <div class="hidden-cart-c">
                	<ul>
                		...
                		<li>
                        	<a href="goods.do?a=show&id=${g.id }"><img src="${g.goodspic }" width="60" height="60" /></a>
                            <p><a href="goods.do?a=show&id=${g.id }">${g.gname}</a></p>
                        ...
                        <li>
                            ...
                            <p><a href="#">测试用：小米盒子增强版 1G 黑色</a></p>
                            <pre>299元 x 1</pre>
                            <ins>x</ins>
						</li>
                    </ul>
        ...
        <div class="navwrap">
            <div id="nav">
                <div class="navbar clearfix">
                    ...
                    <a href="goods.do?a=typeList&id=1">电子产品</a>
                    <a href="goods.do?a=typeList&id=2">生活用品</a>
                    <a href="goods.do?a=typeList&id=3">食品</a>
                    <a href="goods.do?a=typeList&id=4">图书</a>
                    <a href="goods.do?a=typeList&id=5">娱乐</a>
	...
	<div id="banner">
        <div class="fullSlide">
            <div class="bd">
                <ul>
                    <li _src="url(public/images/bg9.jpg)" style="background:#000 center 0 no-repeat;"><a href="#"></a></li>
                    <li _src="url(public/images/bg7.png)" style="background:#DED5A1 center 0 no-repeat;"><a href="#"></a></li>
                    <li _src="url(public/images/bg10.jpg)" style="background:#FEFF19 center 0 no-repeat;"><a href="#"></a></li>
                </ul>
            </div>
	...
	<div class="main">
    	<!------热门推荐-------->
    	<div class="recommend">
        	<div class="title"><img src="public/picture/rt.png" /><p>热门商品</p></div>
        	<div class="clr20"></div>
            <div class="left">
            	<div class="img"><a href="#"><img src="public/images/datu1.jpg" width="619" height="309" /></a></div>
                <div class="img img_309"><p><strong><a href="#">小米平板冰淇淋软胶保护套1</a></strong><span>59元</span></p><a href="#"><img src="public/picture/502.jpg" width="220" height="220"/></a></div>
                <div class="img img_309"><p><strong><a href="#">小米平板冰淇淋软胶保护套2</a></strong><span>59元</span></p><a href="#"><img src="public/picture/502.jpg" width="220" height="220"/></a></div>
                <div class="img img_309"><p><strong><a href="#">小米平板冰淇淋软胶保护套3</a></strong><span>59元</span></p><a href="#"><img src="public/picture/502.jpg" width="220" height="220"/></a></div>
                <div class="img img_309"><p><strong><a href="#">小米平板冰淇淋软胶保护套4</a></strong><span>59元</span></p><a href="#"><img src="public/picture/502.jpg" width="220" height="220"/></a></div>
            </div>
            <div class="right">
                ...
                <ul class="board-list">
                	...
                	<li>
                        ...
                        <span class="item-thumb"><a href="#"><img src="public/picture/01.jpg" width="70" height="70" /></a></span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="item-thumb"><a href="#"><img src="public/picture/02.jpg" width="70" height="70" /></a></span>
                    </li>
                    <li>
                        ...
                        <span class="item-thumb"><a href="#"><img src="public/picture/502.jpg" width="70" height="70" /></a></span>
                    </li>
                    <li>
                        ...
                        <span class="item-thumb"><a href="#"><img src="public/picture/04.jpg" width="70" height="70" /></a></span>
                    </li>
                    <li>
                        ...
                        <span class="item-thumb"><a href="#"><img src="public/picture/05.jpg" width="70" height="70" /></a></span>
                    </li>
                </ul>
            </div>
        </div>
